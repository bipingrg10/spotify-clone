...
2. To create a branch, use `git checkout -b <new-branch-name> [<base-branch-name>]`, where `base-branch-name` is optional and defaults to `main`.
   ...
   I'm going to create a new branch called `ram-dev` from the `main` branch and push it to github.

   ```bash
    git checkout -b ram-dev main
...
5. Select the `main` branch as the `base` branch and the `ram-dev` branch as the `compare` branch.
